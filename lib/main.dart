...
// import 'navegation/pass_arguments.dart';
...
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:prueba/neftworkijng/fech_data.dart';
import 'package:prueba/persitence/dasebatos.dart';
import 'navegation/hero.dart';
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: TextTheme(
          ...
          titleLarge: GoogleFonts.lato(fontSize: 20.0, fontStyle: FontStyle.italic),
        ...
        child: ListView(
          ...
          children: [
            const DrawerHeader(
              ...
              child: Text('Practicas 2'),
            ),
            ListTile(
              title: const Text('Navegation'),
