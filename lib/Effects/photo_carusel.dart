    ...
    return ValueListenableBuilder(
      ...
      builder: (context, color, child) {
        return Image.network(
          'https://resources.sanborns.com.mx/imagenes-sanborns-ii/1200/850005584162.jpg',
    ...
    return GestureDetector(
      ...
      child: AspectRatio(
        ...
        child: Padding(
          ...
          child: ClipOval(
            child: Image.network('https://resources.sanborns.com.mx/imagenes-sanborns-ii/1200/850005584162.jpg',
              color: color.withOpacity(0.5),
